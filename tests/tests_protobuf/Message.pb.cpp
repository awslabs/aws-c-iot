...
Message::Message(const Message& from)
  ...
  ::memcpy(&type_, &from.type_,
    static_cast<size_t>(reinterpret_cast<char*>(&ignorable_) -
    reinterpret_cast<char*>(&type_)) + sizeof(ignorable_));
...
namespace google {
namespace protobuf {
template<> GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::com::amazonaws::iot::securedtunneling::Message* Arena::CreateMaybeMessage< ::com::amazonaws::iot::securedtunneling::Message >(Arena* arena) {
