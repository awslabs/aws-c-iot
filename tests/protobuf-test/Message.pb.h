...
namespace google {
namespace protobuf {
template<> ::com::amazonaws::iot::securedtunneling::Message* Arena::CreateMaybeMessage<::com::amazonaws::iot::securedtunneling::Message>(Arena*);
}  // namespace protobuf
}  // namespace google
namespace com {
namespace amazonaws {
...
class Message : public ::google::protobuf::MessageLite /* @@protoc_insertion_point(class_definition:com.amazonaws.iot.securedtunneling.Message) */ {
 public:
  Message();
  virtual ~Message();
  ...
  static const Type DATA =
    Message_Type_DATA;
  static const Type STREAM_START =
    Message_Type_STREAM_START;
  static const Type STREAM_RESET =
    Message_Type_STREAM_RESET;
  static const Type SESSION_RESET =
    Message_Type_SESSION_RESET;
